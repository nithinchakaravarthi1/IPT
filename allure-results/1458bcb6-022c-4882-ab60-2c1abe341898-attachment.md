...
```ts
  ...
  275 |     // await page.getByAltText('Appliances for your home | Up to 55% off').click({button: "right"});
  276 |     // await page.waitForTimeout(4000);
  277 |     // await page.mouse.wheel(0,900);
  278 |     // await page.waitForTimeout(10000);
> 279 |     await page.goto('https://www.amazon.in/');
      |                ^ Error: page.goto: Target page, context or browser has been closed
  280 |     await page.getByRole('button',{name:'Double Click Me'}).click();
  281 |     await page.waitForTimeout(5000);
  282 | })
```